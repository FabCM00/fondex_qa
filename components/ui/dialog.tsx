...
function DialogContent({
  ...
  mostrarCerrar = true,
  ...props
}: DialogPrimitive.Popup.Props & { mostrarCerrar?: boolean }) {
  return (
    <DialogPortal>
      <DialogOverlay />
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed start-1/2 top-1/2 z-50 flex w-[calc(100vw-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-xl border bg-background p-6 shadow-lg transition-all duration-150",
